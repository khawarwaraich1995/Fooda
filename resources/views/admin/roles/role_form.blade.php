...
<?php
      if (isset($role_data->id) && $role_data->id != 0) {
          $submit_url = route('admin:role.update', [$role_data->id ?? '']);
      } else {
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4 offset-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-alternative" type="text" value="{{$roles_data->title ?? ''}}" id="title" name="title">
                  </div>
                </div>
              </div>
            </fieldset>
